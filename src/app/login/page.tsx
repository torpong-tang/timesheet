                        ...
                        <div className="grid gap-2">
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    required
                                    className="h-12 rounded-lg border-stone-600 bg-stone-800 pl-10 pr-12 font-medium text-stone-100 placeholder:text-stone-500 focus:border-primary"
                                />
                                <button
                                    type="button"
                                    ...
                                    className="absolute right-2 top-1/2 inline-flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-md text-stone-400 transition hover:bg-stone-700 hover:text-amber-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400"
                                >
                                    {showPassword
