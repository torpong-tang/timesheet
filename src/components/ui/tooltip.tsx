  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn("z-[100] rounded-md border border-stone-600 bg-stone-900 px-3 py-1.5 text-xs font-medium text-stone-100 shadow-xl data-[state=delayed-open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=delayed-open]:fade-in-0", className)}
        {...props}
      >
        {children}
